...
const components = {
  Obj: {
    type: 'object',
    properties: { id: { type: 'string' }, nested: { $ref: '#/components/schemas/Inner' } },
    required: ['id'],
  },
  Inner: {
    type: 'object',
    properties: { val: { type: 'integer', format: 'int32' } },
    required: ['val'],
  },
  Container: {
    type: 'object',
    properties: { items: { type: 'array', items: { $ref: '#/components/schemas/Inner' } } },
  },
};
