...
describe('generate typed index.ts', () => {
  ...
  it('emits index.ts with RESPONSE_INDEX and typed wrapper', async () => {
    ...
    // responsesFile and outputDir environment resolution – simpler: call internal extractResponses directly is possible,
    ...
    const formatRouteIndex = (value: unknown) =>
    ...
    expect(indexSource).toContain('truncateValidationErrors?: boolean');
